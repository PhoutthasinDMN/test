...
<section class="py-12 bg-white">
    <div class="container mx-auto px-6">
        <div class="max-w-4xl mx-auto text-center">
            <h2 class="text-3xl font-bold text-blue-800 mb-6"><?php echo t("ວິໄສທັດຂອງຜູ້ນຳ", "Leadership Vision"); ?></h2>
...
<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-6">
        <div class="text-center mb-16">
            <h2 class="text-3xl font-bold text-blue-800 mb-4"><?php echo t("ທີມບໍລິຫານລະດັບສູງ", "Executive Team"); ?></h2>
                ...
                <div class="p-6">
                    ...
                    <div class="border-t pt-4">
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span class="text-blue-600"><?php echo t("MD, Ph.D. ມະຫາວິທະຍາໄລຊິງກະໂປ", "MD, Ph.D. Singapore University"); ?></span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600"><?php echo t("ຄວາມເຊີ່ຍວຊານ", "Expertise"); ?></span>
                            <span class="text-blue-600"><?php echo t("ການບໍລິຫານທາງການແພດ", "Medical Administration"); ?></span>
                        </div>
                    </div>
                    <div class="mt-6 flex justify-center space-x-4">
                        ...
                        <a href="#" class="text-blue-900 hover:text-blue-700 transition duration-300">
            ...
            <div class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300 transform hover:-translate-y-2">
                ...
                <div class="p-6">
                    ...
                    <div class="border-t pt-4">
                        <div class="flex justify-between items-center mb-2">
                            <span class="text-gray-600"><?php echo t("ການສຶກສາ", "Education"); ?></span>
                            <span class="text-blue-600"><?php echo t("MBA ມະຫາວິທະຍາໄລຈຸລາລົງກອນ", "MBA Chulalongkorn University"); ?></span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600"><?php echo t("ຄວາມເຊີ່ຍວຊານ", "Expertise"); ?></span>
                            <span class="text-blue-600"><?php echo t("ການປັບປຸງຄຸນນະພາບ, ການຈັດການທຸລະກິດ", "Quality Improvement, Business Management"); ?></span>
                        </div>
                    </div>
                    <div class="mt-6 flex justify-center space-x-4">
                        <a href="#" class="text-blue-600 hover:text-blue-800 transition duration-300">
            ...
            <div class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300 transform hover:-translate-y-2">
                ...
                <div class="p-6">
                    ...
                    <div class="border-t pt-4">
                        <div class="flex justify-between items-center mb-2">
                            <span class="text-gray-600"><?php echo t("ການສຶກສາ", "Education"); ?></span>
                            <span class="text-blue-600"><?php echo t("CPA, ປະລິນຍາໂທ ການບັນຊີ", "CPA, Master's in Accounting"); ?></span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600"><?php echo t("ຄວາມເຊີ່ຍວຊານ", "Expertise"); ?></span>
                            <span class="text-blue-600"><?php echo t("ການເງິນດ້ານສຸຂະພາບ, ການວາງແຜນງົບປະມານ", "Healthcare Finance, Budget Planning"); ?></span>
                        </div>
                    </div>
                    <div class="mt-6 flex justify-center space-x-4">
                        <a href="#" class="text-blue-600 hover:text-blue-800 transition duration-300">
...
<section class="py-16 bg-white">
    <div class="container mx-auto px-6">
        <div class="text-center mb-16">
            <h2 class="text-3xl font-bold text-blue-800 mb-4"><?php echo t("ຜູ້ນຳຝ່າຍຕ່າງໆ", "Department Leaders"); ?></h2>
            <p class="text-lg text-gray-600 max-w-3xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition duration-300">
                <div class="relative">
                    ...
                    <div class="absolute inset-0 bg-blue-900 bg-opacity-30 hover:bg-opacity-20 transition duration-300 flex items-center justify-center opacity-0 hover:opacity-100">
                ...
                <div class="p-4 text-center">
                    <h3 class="text-lg font-semibold text-blue-800 mb-1"><?php echo t("ພຍ. ສຸກສະໄໝ ວິໄຊຄຳ", "Nurse Suksmai Visaykham"); ?></h3>
                    <p class="text-blue-600 text-sm mb-2"><?php echo t("ຫົວໜ້າພະຍາບານ", "Head of Nursing"); ?></p>
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition duration-300">
                ...
                <div class="p-4 text-center">
                    <h3 class="text-lg font-semibold text-blue-800 mb-1"><?php echo t("ທ.ນ. ສົມຈິດ ດາວະພອນ", "Ms. Somjit Davaphon"); ?></h3>
                    <p class="text-blue-600 text-sm mb-2"><?php echo t("ຜູ້ອຳນວຍການຝ່າຍການຕະຫຼາດ", "Marketing Director"); ?></p>
                    <div class="flex justify-center space-x-3 mt-3">
                        <a href="#" class="text-blue-600 hover:text-blue-800 transition duration-300">
                            <i class="fab fa-linkedin"></i>
                        </a>
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition duration-300">
                ...
                <div class="p-4 text-center">
                    <h3 class="text-lg font-semibold text-blue-800 mb-1"><?php echo t("ທ. ວິຊິດ ປັນຍາລາດ", "Mr. Vichit Panyalad"); ?></h3>
                    <p class="text-blue-600 text-sm mb-2"><?php echo t("ຜູ້ຈັດການຝ່າຍຊັບພະຍາກອນມະນຸດ", "HR Manager"); ?></p>
                    <div class="flex justify-center space-x-3 mt-3">
                        <a href="#" class="text-blue-600 hover:text-blue-800 transition duration-300">
                            <i class="fab fa-linkedin"></i>
                        </a>
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition duration-300">
                ...
                <div class="p-4 text-center">
                    <h3 class="text-lg font-semibold text-blue-800 mb-1"><?php echo t("ທ. ນນທວັດ ຈັນປະເສີດ", "Mr. Nonthawat Janprasert"); ?></h3>
                    <p class="text-blue-600 text-sm mb-2"><?php echo t("ຜູ້ອຳນວຍການຝ່າຍເຕັກໂນໂລຊີ", "IT Director"); ?></p>
                    <div class="flex justify-center space-x-3 mt-3">
                        <a href="#" class="text-blue-600 hover:text-blue-800 transition duration-300">
                            <i class="fab fa-linkedin"></i>
                        </a>
    ...
    <div class="container mx-auto px-6">
        <div class="max-w-5xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div>
                    <h2 class="text-3xl font-bold text-blue-800 mb-6"><?php echo t("ວິທີການບໍລິຫານຂອງພວກເຮົາ", "Our Management Approach"); ?></h2>
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            <div class="flex-shrink-0 h-6 w-6 rounded-full bg-blue-600 flex items-center justify-center mt-1">
...
<section class="py-16 bg-white">
    <div class="container mx-auto px-6">
        <div class="text-center mb-16">
            <h2 class="text-3xl font-bold text-blue-800 mb-4"><?php echo t("ຜົນສຳເລັດແລະການຍອມຮັບ", "Achievements and Recognition"); ?></h2>
            <p class="text-lg text-gray-600 max-w-3xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div class="bg-blue-50 rounded-lg p-6 text-center hover:shadow-lg transition duration-300">
                ...
                <h3 class="text-xl font-semibold text-blue-800 mb-3"><?php echo t("ຄລີນິກທີ່ດີເລີດແຫ່ງປີ 2023", "Excellence in Clinical Care 2023"); ?></h3>
            ...
            <div class="bg-blue-50 rounded-lg p-6 text-center hover:shadow-lg transition duration-300">
                ...
                <h3 class="text-xl font-semibold text-blue-800 mb-3"><?php echo t("ການຮັບຮອງມາດຕະຖານ JCI", "JCI Accreditation"); ?></h3>
                <p class="text-gray-700">
            ...
            <div class="bg-blue-50 rounded-lg p-6 text-center hover:shadow-lg transition duration-300">
                ...
                <h3 class="text-xl font-semibold text-blue-800 mb-3"><?php echo t("ຄວາມພໍໃຈຂອງຄົນເຈັບ 95%", "95% Patient Satisfaction"); ?></h3>
                <p class="text-gray-700">
...
<section class="py-16 bg-blue-800 text-white">
    <div class="container mx-auto px-6">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <a href="careers.php" class="inline-block bg-white text-blue-800 px-8 py-4 rounded-lg font-bold text-lg hover:bg-blue-100 transition duration-300">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                <div class="md:flex">
                    <div class="md:w-1/2 p-8 md:p-12">
                        <h2 class="text-2xl font-bold text-blue-800 mb-6"><?php echo t("ຕິດຕໍ່ທີມບໍລິຫານ", "Contact Management"); ?></h2>
                        <p class="text-gray-700 mb-6">
                    ...
                    <div class="md:w-1/2 bg-blue-600 p-8 md:p-12 text-white">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start">
                                <div class="flex-shrink-0 h-6 w-6 rounded-full bg-blue-500 flex items-center justify-center mt-1">
                                    <i class="fas fa-envelope text-xs"></i>
                                </div>
                                <div class="ml-3">
                                    <p class="font-medium"><?php echo t("ອີເມວ", "Email"); ?></p>
                                    <p class="text-blue-100">management@onemeds.com</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                <div class="flex-shrink-0 h-6 w-6 rounded-full bg-blue-500 flex items-center justify-center mt-1">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p class="text-blue-100"><?php echo SITE_PHONE; ?></p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                <div class="flex-shrink-0 h-6 w-6 rounded-full bg-blue-500 flex items-center justify-center mt-1">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p class="text-blue-100"><?php echo SITE_ADDRESS; ?></p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                <div class="flex-shrink-0 h-6 w-6 rounded-full bg-blue-500 flex items-center justify-center mt-1">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p class="text-blue-100"><?php echo t("ຈັນ-ສຸກ: 8:00 - 17:00", "Mon-Fri: 8:00 - 17:00"); ?></p>
                                </div>
                            </div>
                        </div>
