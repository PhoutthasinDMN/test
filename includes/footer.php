    ...
    <div class="fixed bottom-6 right-6 z-50 flex flex-col space-y-4">
        ...
        <!-- ปุ่ม WhatsApp ด้วย SVG -->
        <a href="https://wa.me/2078888789" target="_blank"
            class="social-popup bg-green-500 text-white w-12 h-12 rounded-full flex items-center justify-center shadow-lg hover:bg-green-600 transition-all duration-300 transform hover:scale-110">
            <svg class="w-6 h-6 text-white" viewBox="0 0 448 512" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- ปุ่ม Instagram ด้วย SVG -->
        <a href="#" target="_blank"
            class="social-popup bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 text-white w-12 h-12 rounded-full flex items-center justify-center shadow-lg hover:opacity-90 transition-all duration-300 transform hover:scale-110">
            <svg class="w-6 h-6 text-white" viewBox="0 0 448 512" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- ปุ่ม Line ด้วย SVG -->
        <a href="#" target="_blank"
            class="social-popup bg-green-400 text-white w-12 h-12 rounded-full flex items-center justify-center shadow-lg hover:bg-green-500 transition-all duration-300 transform hover:scale-110">
            <svg class="w-6 h-6 text-white" viewBox="0 0 448 512" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
