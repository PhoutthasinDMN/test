...
<!-- Page Header -->
<section class="py-12 bg-gradient-to-r from-teal-200 from-teal-400">
    <div class="container mx-auto px-6 text-center">
        ...
        <p class="text-xl text-teal-600 max-w-3xl mx-auto">
    ...
    <div class="container mx-auto px-6">
        <div class="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div class="w-full md:w-2/3 flex flex-wrap gap-3 justify-end">
                <button class="filter-btn active px-4 py-2 rounded-full bg-teal-600 text-white border-2 border-teal-600 hover:bg-teal-700 transition duration-300" data-filter="all">
                    <?php echo t("ທັງໝົດ", "All"); ?>
                </button>
                <button class="filter-btn px-4 py-2 rounded-full bg-white text-teal-600 border-2 border-teal-600 hover:bg-teal-50 transition duration-300" data-filter="internal-medicine">
                    <?php echo t("ອາຍຸລະກຳ", "Internal Medicine"); ?>
                </button>
                <button class="filter-btn px-4 py-2 rounded-full bg-white text-teal-600 border-2 border-teal-600 hover:bg-teal-50 transition duration-300" data-filter="pediatrics">
                    <?php echo t("ກຸມາລະເວດຊະກຳ", "Pediatrics"); ?>
                </button>
                <button class="filter-btn px-4 py-2 rounded-full bg-white text-teal-600 border-2 border-teal-600 hover:bg-teal-50 transition duration-300" data-filter="dermatology">
                    <?php echo t("ຜິວໜັງ", "Dermatology"); ?>
                </button>
                <button class="filter-btn px-4 py-2 rounded-full bg-white text-teal-600 border-2 border-teal-600 hover:bg-teal-50 transition duration-300" data-filter="surgery">
...
<section class="py-16">
    <div class="container mx-auto px-6">
        <h2 class="text-3xl font-bold text-center text-teal-800 mb-12"><?php echo t("ແພດຜູ້ຊ່ຽວຊານຂອງພວກເຮົາ", "Our Medical Specialists"); ?></h2>
            ...
            <div class="team-member bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition duration-300 transform hover:-translate-y-2" data-category="internal-medicine">
                <div class="relative">
                    ...
                    <div class="absolute top-4 right-4">
                        <span class="bg-teal-600 text-white text-sm px-3 py-1 rounded-full">
                            <?php echo t("ອາຍຸລະກຳ", "Internal Medicine"); ?>
                        </span>
                    </div>
                    <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-teal-900 to-transparent text-white p-6">
                ...
                <div class="p-6">
                    ...
                    <div class="border-t pt-4">
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span class="text-teal-600"><?php echo t("ປະລິນຍາເອກ MD", "MD, PhD"); ?></span>
                        </div>
                        <div class="flex justify-between items-center mb-2">
                            <span class="text-gray-600"><?php echo t("ພາສາ", "Languages"); ?></span>
                            <span class="text-teal-600"><?php echo t("ລາວ, ໄທ, ອັງກິດ", "Lao, Thai, English"); ?></span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600"><?php echo t("ປະສົບການ", "Experience"); ?></span>
                            <span class="text-teal-600">15 <?php echo t("ປີ", "years"); ?></span>
                        </div>
                    </div>

                    <div class="mt-6 flex justify-between">
                        <a href="doctor-profile.php?id=1" class="text-teal-600 hover:text-teal-800 font-medium">
                            <?php echo t("ເບິ່ງໂປຣໄຟລ໌", "View Profile"); ?> <i class="fas fa-arrow-right ml-1"></i>
                        </a>
                        <a href="appointments.php?doctor=1" class="bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 rounded-lg font-medium transition duration-300">
            ...
            <div class="team-member bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition duration-300 transform hover:-translate-y-2" data-category="pediatrics">
                ...
                <div class="p-6">
                    ...
                    <div class="border-t pt-4">
                        <div class="flex justify-between items-center mb-2">
                            <span class="text-gray-600"><?php echo t("ຄຸນວຸດທິ", "Qualifications"); ?></span>
                            <span class="text-teal-600"><?php echo t("ປະລິນຍາຕີ MD", "MD"); ?></span>
                        </div>
                        <div class="flex justify-between items-center mb-2">
                            <span class="text-gray-600"><?php echo t("ພາສາ", "Languages"); ?></span>
                            <span class="text-teal-600"><?php echo t("ລາວ, ໄທ, ອັງກິດ", "Lao, Thai, English"); ?></span>
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600"><?php echo t("ປະສົບການ", "Experience"); ?></span>
                            <span class="text-teal-600">10 <?php echo t("ປີ", "years"); ?></span>
                        </div>
                    </div>

                    <div class="mt-6 flex justify-between">
                        <a href="doctor-profile.php?id=2" class="text-teal-600 hover:text-teal-800 font-medium">
                            <?php echo t("ເບິ່ງໂປຣໄຟລ໌", "View Profile"); ?> <i class="fas fa-arrow-right ml-1"></i>
                        </a>
                        <a href="appointments.php?doctor=2" class="bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 rounded-lg font-medium transition duration-300">
                            <?php echo t("ນັດໝາຍ", "Book Appointment"); ?>
                        </a>
                    </div>
                </div>
            ...
            <div class="team-member bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition duration-300 transform hover:-translate-y-2" data-category="dermatology">
                ...
                <div class="p-6">
                    ...
                    <div class="border-t pt-4">
                        ...
                        <div class="flex justify-between items-center mb-2">
                            <span class="text-gray-600"><?php echo t("ພາສາ", "Languages"); ?></span>
                            <span class="text-teal-600"><?php echo t("ລາວ, ໄທ, ອັງກິດ, ຝຣັ່ງ", "Lao, Thai, English, French"); ?></span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600"><?php echo t("ປະສົບການ", "Experience"); ?></span>
                            <span class="text-teal-600">8 <?php echo t("ປີ", "years"); ?></span>
                        </div>
                    </div>

                    <div class="mt-6 flex justify-between">
                        <a href="doctor-profile.php?id=3" class="text-teal-600 hover:text-teal-800 font-medium">
                            <?php echo t("ເບິ່ງໂປຣໄຟລ໌", "View Profile"); ?> <i class="fas fa-arrow-right ml-1"></i>
                        </a>
                        <a href="appointments.php?doctor=3" class="bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 rounded-lg font-medium transition duration-300">
                            <?php echo t("ນັດໝາຍ", "Book Appointment"); ?>
                        </a>
                    </div>
                </div>
            ...
            <div class="team-member bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition duration-300 transform hover:-translate-y-2" data-category="surgery">
                ...
                <div class="p-6">
                    ...
                    <div class="border-t pt-4">
                        <div class="flex justify-between items-center mb-2">
                            <span class="text-gray-600"><?php echo t("ຄຸນວຸດທິ", "Qualifications"); ?></span>
                            <span class="text-teal-600"><?php echo t("ປະລິນຍາຕີ MD, FACS", "MD, FACS"); ?></span>
                        </div>
                        <div class="flex justify-between items-center mb-2">
                            <span class="text-gray-600"><?php echo t("ພາສາ", "Languages"); ?></span>
                            <span class="text-teal-600"><?php echo t("ລາວ, ໄທ, ອັງກິດ", "Lao, Thai, English"); ?></span>
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600"><?php echo t("ປະສົບການ", "Experience"); ?></span>
                            <span class="text-teal-600">12 <?php echo t("ປີ", "years"); ?></span>
                        </div>
                    </div>

                    <div class="mt-6 flex justify-between">
                        <a href="doctor-profile.php?id=4" class="text-teal-600 hover:text-teal-800 font-medium">
                            <?php echo t("ເບິ່ງໂປຣໄຟລ໌", "View Profile"); ?> <i class="fas fa-arrow-right ml-1"></i>
                        </a>
                        <a href="appointments.php?doctor=4" class="bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 rounded-lg font-medium transition duration-300">
                            <?php echo t("ນັດໝາຍ", "Book Appointment"); ?>
                        </a>
                    </div>
                </div>
            ...
            <div class="team-member bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition duration-300 transform hover:-translate-y-2" data-category="internal-medicine">
                ...
                <div class="p-6">
                    ...
                    <div class="border-t pt-4">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600"><?php echo t("ປະສົບການ", "Experience"); ?></span>
                            <span class="text-teal-600">9 <?php echo t("ປີ", "years"); ?></span>
                        </div>
                    </div>

                    <div class="mt-6 flex justify-between">
                        <a href="doctor-profile.php?id=5" class="text-teal-600 hover:text-teal-800 font-medium">
                            <?php echo t("ເບິ່ງໂປຣໄຟລ໌", "View Profile"); ?> <i class="fas fa-arrow-right ml-1"></i>
                        </a>
                        <a href="appointments.php?doctor=5" class="bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 rounded-lg font-medium transition duration-300">
                            <?php echo t("ນັດໝາຍ", "Book Appointment"); ?>
                        </a>
                    </div>
                </div>
            ...
            <div class="team-member bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition duration-300 transform hover:-translate-y-2" data-category="surgery">
                ...
                <div class="p-6">
                    ...
                    <div class="border-t pt-4">
                        ...
                        <div class="flex justify-between items-center mb-2">
                            <span class="text-gray-600"><?php echo t("ພາສາ", "Languages"); ?></span>
                            <span class="text-teal-600"><?php echo t("ລາວ, ໄທ, ອັງກິດ, ເຢຍລະມັນ", "Lao, Thai, English, German"); ?></span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600"><?php echo t("ປະສົບການ", "Experience"); ?></span>
                            <span class="text-teal-600">11 <?php echo t("ປີ", "years"); ?></span>
                        </div>
                    </div>

                    <div class="mt-6 flex justify-between">
                        <a href="doctor-profile.php?id=6" class="text-teal-600 hover:text-teal-800 font-medium">
                            <?php echo t("ເບິ່ງໂປຣໄຟລ໌", "View Profile"); ?> <i class="fas fa-arrow-right ml-1"></i>
                        </a>
                        <a href="appointments.php?doctor=6" class="bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 rounded-lg font-medium transition duration-300">
                            <?php echo t("ນັດໝາຍ", "Book Appointment"); ?>
                        </a>
                    </div>
                </div>
...
<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-6">
        <h2 class="text-3xl font-bold text-center text-teal-800 mb-12"><?php echo t("ພະຍາບານແລະບຸກຄະລາກອນທີ່ມີຄຸນນະພາບຂອງພວກເຮົາ", "Our Qualified Nurses & Staff"); ?></h2>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition duration-300 text-center">
                <div class="relative">
                    ...
                    <div class="absolute inset-0 bg-teal-900 bg-opacity-20 hover:bg-opacity-40 transition duration-300"></div>
                </div>
                <div class="p-4">
                    <h3 class="text-lg font-semibold text-teal-800 mb-1"><?php echo t("ທ.ນ. ນາລີ ພົມມະວົງ", "Ms. Nalee Phommavong"); ?></h3>
                    <p class="text-teal-600 text-sm mb-2"><?php echo t("ຫົວໜ້າພະຍາບານ", "Head Nurse"); ?></p>
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition duration-300 text-center">
                ...
                <div class="p-4">
                    <h3 class="text-lg font-semibold text-teal-800 mb-1"><?php echo t("ທ. ສົມສະໄໝ ໄຊຍະວົງ", "Mr. Somsamai Xayavong"); ?></h3>
                    <p class="text-teal-600 text-sm mb-2"><?php echo t("ພະຍາບານຫ້ອງສຸກເສີນ", "Emergency Room Nurse"); ?></p>
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition duration-300 text-center">
                ...
                <div class="p-4">
                    <h3 class="text-lg font-semibold text-teal-800 mb-1"><?php echo t("ທ.ນ. ຈັນທະລີ ສີສະຫວັດ", "Ms. Chantalee Sisavath"); ?></h3>
                    <p class="text-teal-600 text-sm mb-2"><?php echo t("ພະຍາບານແຜນກເດັກ", "Pediatric Nurse"); ?></p>
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition duration-300 text-center">
                ...
                <div class="p-4">
                    <h3 class="text-lg font-semibold text-teal-800 mb-1"><?php echo t("ທ.ນ. ມະນີຈັນ ສິງຫາລາດ", "Ms. Maneechan Singhalad"); ?></h3>
                    <p class="text-teal-600 text-sm mb-2"><?php echo t("ຜູ້ຈັດການຄລີນິກ", "Clinic Manager"); ?></p>
    ...
    <div class="container mx-auto px-6">
        <div class="flex flex-col md:flex-row items-center">
            <div class="md:w-2/3 mb-8 md:mb-0 md:pr-12">
                ...
                <p class="text-xl text-teal-100 mb-6">
                ...
                <ul class="mb-8">
                    <li class="flex items-center mb-3">
                        <i class="fas fa-check-circle text-teal-300 mr-3 text-xl"></i>
                ...
                <a href="careers.php" class="inline-block bg-white text-teal-700 px-6 py-3 rounded-lg font-semibold hover:bg-teal-50 transition duration-300">
...
<section class="py-16 bg-white">
    <div class="container mx-auto px-6">
        <h2 class="text-3xl font-bold text-center text-teal-800 mb-12"><?php echo t("ຄຳຖາມທີ່ຖາມເລື້ອຍກ່ຽວກັບທີມຂອງພວກເຮົາ", "Frequently Asked Questions About Our Team"); ?></h2>

        <div class="max-w-3xl mx-auto">
            <!-- FAQ Item 1 -->
            <div class="mb-6 border-b border-gray-200 pb-6">
                <button class="faq-question w-full flex justify-between items-center text-left">
                    <h3 class="text-xl font-semibold text-teal-800"><?php echo t("ທ່ານໝໍຂອງທ່ານມີໃບຢັ້ງຢືນບໍ?", "Are your doctors certified?"); ?></h3>
            ...
            <div class="mb-6 border-b border-gray-200 pb-6">
                <button class="faq-question w-full flex justify-between items-center text-left">
                    <h3 class="text-xl font-semibold text-teal-800"><?php echo t("ຂ້ອຍສາມາດຂໍໝໍເຈາະຈົງໄດ້ບໍ?", "Can I request a specific doctor?"); ?></h3>
                    <i class="fas fa-chevron-down text-teal-600 transition-transform duration-300"></i>
                </button>
                <div class="faq-answer mt-4 text-gray-700 hidden">
            ...
            <div class="mb-6 border-b border-gray-200 pb-6">
                <button class="faq-question w-full flex justify-between items-center text-left">
                    <h3 class="text-xl font-semibold text-teal-800"><?php echo t("ທ່ານໝໍຂອງທ່ານເວົ້າພາສາຫຍັງແດ່?", "What languages do your doctors speak?"); ?></h3>
                    <i class="fas fa-chevron-down text-teal-600 transition-transform duration-300"></i>
                </button>
                <div class="faq-answer mt-4 text-gray-700 hidden">
            ...
            <div class="mb-6 border-b border-gray-200 pb-6">
                <button class="faq-question w-full flex justify-between items-center text-left">
                    <h3 class="text-xl font-semibold text-teal-800"><?php echo t("ພຽງແຕ່ທຽມໝໍເທົ່ານັ້ນທີ່ຢູ່ໃນທີມຂອງທ່ານບໍ?", "Are only doctors part of your team?"); ?></h3>
                    <i class="fas fa-chevron-down text-teal-600 transition-transform duration-300"></i>
                </button>
                <div class="faq-answer mt-4 text-gray-700 hidden">
            ...
            <div class="mb-6">
                <button class="faq-question w-full flex justify-between items-center text-left">
                    <h3 class="text-xl font-semibold text-teal-800"><?php echo t("ຂ້ອຍສາມາດອ່ານກ່ຽວກັບຄຳເຫັນຂອງຄົນໄຂ້ກ່ຽວກັບແພດຂອງທ່ານໄດ້ບໍ?", "Can I read patient reviews about your doctors?"); ?></h3>
                    <i class="fas fa-chevron-down text-teal-600 transition-transform duration-300"></i>
                </button>
                <div class="faq-answer mt-4 text-gray-700 hidden">
...
<section class="py-16 bg-teal-600 text-white">
    <div class="container mx-auto px-6 text-center">
        ...
        <div class="flex flex-col md:flex-row justify-center space-y-4 md:space-y-0 md:space-x-6">
            <a href="appointments.php" class="bg-white text-teal-700 hover:bg-teal-50 px-8 py-4 rounded-lg font-bold text-lg transition duration-300">
                <?php echo t("ນັດໝາຍ", "Book an Appointment"); ?>
            </a>
            <a href="contact.php" class="border-2 border-white text-white hover:bg-teal-700 px-8 py-4 rounded-lg font-bold text-lg transition duration-300">
